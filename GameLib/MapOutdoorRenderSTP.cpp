...
void CMapOutdoor::__SoftwareTransformPatch_BuildPipeline(SoftwareTransformPatch_SRenderState& rkTPRS)
{
	...
	D3DXVECTOR3 tempNearVector(0.0f, 0.0f, -rkTPRS.m_fFogNearDistance);
	D3DXVec3TransformCoord(&kFogNearVector, &tempNearVector, &rkTPRS.m_m4Proj);

	D3DXVECTOR3 kFogFarVector;
	D3DXVECTOR3 tempFarVector(0.0f, 0.0f, -rkTPRS.m_fFogFarDistance);
	D3DXVec3TransformCoord(&kFogFarVector, &tempFarVector, &rkTPRS.m_m4Proj);

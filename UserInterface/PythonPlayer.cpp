...
void CPythonPlayer::SPlayerStatus::SetGold(long long gold)
{
	m_lldGold = gold;
}

long long CPythonPlayer::SPlayerStatus::GetGold()
{
	return m_lldGold;
}
#endif
...
int CPythonPlayer::GetPointByApply(int applyType)
{
	switch (applyType) {
		case CItemData::APPLY_NORMAL_HIT_DAMAGE_BONUS:
			return POINT_NORMAL_HIT_DAMAGE_BONUS;
		case CItemData::APPLY_SKILL_DAMAGE_BONUS:
			return POINT_SKILL_DAMAGE_BONUS;
		case CItemData::APPLY_RESIST_SWORD:
			return POINT_RESIST_SWORD;
		case CItemData::APPLY_RESIST_TWOHAND:
			return POINT_RESIST_TWOHAND;
		case CItemData::APPLY_RESIST_DAGGER:
			return POINT_RESIST_DAGGER;
		case CItemData::APPLY_RESIST_BELL:
			return POINT_RESIST_BELL;
		case CItemData::APPLY_RESIST_FAN:
			return POINT_RESIST_FAN;
		case CItemData::APPLY_RESIST_BOW:
			return POINT_RESIST_BOW;
		case CItemData::APPLY_RESIST_MAGIC:
			return POINT_RESIST_MAGIC;
		case CItemData::APPLY_POISON_PCT:
			return POINT_POISON_PCT;
		case CItemData::APPLY_STUN_PCT:
			return POINT_STUN_PCT;
		case CItemData::APPLY_SLOW_PCT:
			return POINT_SLOW_PCT;
		case CItemData::APPLY_CRITICAL_PCT:
			return POINT_CRITICAL_PCT;
		case CItemData::APPLY_PENETRATE_PCT:
			return POINT_PENETRATE_PCT;
		case CItemData::APPLY_ATTBONUS_HUMAN:
			return POINT_ATTBONUS_HUMAN;
		case CItemData::APPLY_ATTBONUS_ANIMAL:
			return POINT_ATTBONUS_ANIMAL;
		case CItemData::APPLY_ATTBONUS_ORC:
			return POINT_ATTBONUS_ORC;
		case CItemData::APPLY_ATTBONUS_MILGYO:
			return POINT_ATTBONUS_MILGYO;
		case CItemData::APPLY_ATTBONUS_UNDEAD:
			return POINT_ATTBONUS_UNDEAD;
		case CItemData::APPLY_ATTBONUS_DEVIL:
			return POINT_ATTBONUS_DEVIL;
		case CItemData::APPLY_STEAL_HP:
			return POINT_STEAL_HP;
		case CItemData::APPLY_STEAL_SP:
			return POINT_STEAL_SP;
		case CItemData::APPLY_MANA_BURN_PCT:
			return POINT_MANA_BURN_PCT;
		case CItemData::APPLY_DAMAGE_SP_RECOVER:
			return POINT_DAMAGE_SP_RECOVER;
		case CItemData::APPLY_BLOCK:
			return POINT_BLOCK;
		case CItemData::APPLY_DODGE:
			return POINT_DODGE;
		case CItemData::APPLY_RESIST_FIRE:
			return POINT_RESIST_FIRE;
		case CItemData::APPLY_RESIST_ELEC:
			return POINT_RESIST_ELEC;
		case CItemData::APPLY_RESIST_WIND:
			return POINT_RESIST_WIND;
		case CItemData::APPLY_REFLECT_MELEE:
			return POINT_REFLECT_MELEE;
		case CItemData::APPLY_REFLECT_CURSE:
			return POINT_REFLECT_CURSE;
		case CItemData::APPLY_HP_REGEN:
			return POINT_HP_REGEN;
		case CItemData::APPLY_SP_REGEN:
			return POINT_SP_REGEN;
		case CItemData::APPLY_POISON_REDUCE:
			return POINT_POISON_REDUCE;
		case CItemData::APPLY_KILL_SP_RECOVER:
			return POINT_KILL_SP_RECOVER;
		case CItemData::APPLY_EXP_DOUBLE_BONUS:
			return POINT_EXP_DOUBLE_BONUS;
		case CItemData::APPLY_GOLD_DOUBLE_BONUS:
			return POINT_GOLD_DOUBLE_BONUS;
		case CItemData::APPLY_ITEM_DROP_BONUS:
			return POINT_ITEM_DROP_BONUS;
		case CItemData::APPLY_POTION_BONUS:
			return POINT_POTION_BONUS;
		case CItemData::APPLY_KILL_HP_RECOVER:
			return POINT_KILL_HP_RECOVER;
		case CItemData::APPLY_BOW_DISTANCE:
			return POINT_BOW_DISTANCE;
		case CItemData::APPLY_DEF_GRADE_BONUS:
			return POINT_DEF_GRADE_BONUS;
		case CItemData::APPLY_ATT_GRADE_BONUS:
			return POINT_ATT_GRADE_BONUS;
		case CItemData::APPLY_MAGIC_ATT_GRADE:
			return POINT_MAGIC_ATT_GRADE;
		case CItemData::APPLY_MAGIC_DEF_GRADE:
			return POINT_MAGIC_DEF_GRADE;
		case CItemData::APPLY_MAX_STAMINA:
			return POINT_MAX_STAMINA;
		case CItemData::APPLY_MALL_ATTBONUS:
			return POINT_MALL_ATTBONUS;
		case CItemData::APPLY_MALL_DEFBONUS:
			return POINT_MALL_DEFBONUS;
		case CItemData::APPLY_MALL_EXPBONUS:
			return POINT_MALL_EXPBONUS;
		case CItemData::APPLY_MALL_ITEMBONUS:
			return POINT_MALL_ITEMBONUS;
		case CItemData::APPLY_MALL_GOLDBONUS:
			return POINT_MALL_GOLDBONUS;
		default: 
			return POINT_NONE;
	}
}
...
#ifdef ENABLE_REMOVE_LIMIT_GOLD
void CPythonPlayer::SetGold(long long value)
{
	m_playerStatus.SetGold(value);
}

long long CPythonPlayer::GetGold()
{

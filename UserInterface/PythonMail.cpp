...
CPythonMail::SMailBoxAddData::SMailBoxAddData(const char* _From, const char* _Message, const int _Yang,
...
PyObject* mailGetMailAddData(PyObject* poSelf, PyObject* poArgs)
{
	...
	return Py_BuildValue("ssi", addData->sFrom.c_str(), addData->sMessage.c_str(), addData->iYang);
}

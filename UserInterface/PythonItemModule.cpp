...
void initItem()
{
	...
	PyModule_AddIntConstant(poModule, "COSTUME_TYPE_EFFECT_ARMOR",	CItemData::EFFECT_ARMOR);
	PyModule_AddIntConstant(poModule, "COSTUME_TYPE_EFFECT_WEAPON",	CItemData::EFFECT_WEAPON);
#ifdef ENABLE_COSTUME_WEAPON
	...
	PyModule_AddIntConstant(poModule, "COSTUME_SLOT_EFFECT_ARMOR",	c_Costume_Effect_Body);
	PyModule_AddIntConstant(poModule, "COSTUME_SLOT_EFFECT_WEAPON",	c_Costume_Effect_Weapon);

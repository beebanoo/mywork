...
#endif
#ifdef ENABLE_TITLE_PERSO
	kCreateData.m_PTitle = rkNetActorData.m_PTitle;
#endif
...
#endif
#ifdef ENABLE_TITLE_PERSO
		pkInstFind->SetPTitle(c_rkNetUpdateActorData.m_PTitle.c_str());
#endif
...
#endif
#ifdef ENABLE_TITLE_PERSO
	rkNetActorData.m_PTitle = c_rkNetUpdateActorData.m_PTitle;
#endif

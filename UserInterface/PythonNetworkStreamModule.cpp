...
PyObject* netSendCreateCharacterPacket(PyObject* poSelf, PyObject* poArgs)
{
	...
	char* refferal;
	if (!PyTuple_GetString(poArgs, 8, &refferal))
		return Py_BuildException();
#endif
...
PyObject* netSendPostWrite(PyObject* poSelf, PyObject* poArgs)
{
	...
	CPythonNetworkStream::Instance().SendPostWrite(szName, szTitle, szMessage, Cell, iYang);
	return Py_BuildNone();
}
...
void initnet()
{
	...
	PyObject* poModule = Py_InitModule("__t_2_n_e_t__", s_methods);

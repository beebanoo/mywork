...
void initchrmgr()
{
	...
	PyObject * poModule = Py_InitModule("__t_2_c_h_r_m_g_r__", s_methods);
	...
	PyModule_AddIntConstant(poModule, "EFFECT_DRAGON_BLACK",		CInstanceBase::EFFECT_DRAGON_BLACK);
	PyModule_AddIntConstant(poModule, "EFFECT_DRAGON_PURPLE",		CInstanceBase::EFFECT_DRAGON_PURPLE);
	PyModule_AddIntConstant(poModule, "EFFECT_DRAGON_BLUE",			CInstanceBase::EFFECT_DRAGON_BLUE);
	PyModule_AddIntConstant(poModule, "EFFECT_DRAGON_GOLD",			CInstanceBase::EFFECT_DRAGON_GOLD);
	PyModule_AddIntConstant(poModule, "EFFECT_DRAGON_GREEN",		CInstanceBase::EFFECT_DRAGON_GREEN);
	PyModule_AddIntConstant(poModule, "EFFECT_DRAGON_GRAY",			CInstanceBase::EFFECT_DRAGON_GRAY);
	PyModule_AddIntConstant(poModule, "EFFECT_DRAGON_TURCOAZ",		CInstanceBase::EFFECT_DRAGON_TURCOAZ);
	PyModule_AddIntConstant(poModule, "EFFECT_DRAGON_YELLOW",		CInstanceBase::EFFECT_DRAGON_YELLOW);
	PyModule_AddIntConstant(poModule, "EFFECT_DRAGON_WHITE",		CInstanceBase::EFFECT_DRAGON_WHITE);
	PyModule_AddIntConstant(poModule, "EFFECT_DRAGON_PINK",			CInstanceBase::EFFECT_DRAGON_PINK);
	PyModule_AddIntConstant(poModule, "EFFECT_DRAGON_RED",			CInstanceBase::EFFECT_DRAGON_RED);
	PyModule_AddIntConstant(poModule, "EFFECT_DRAGON_ORANGE",		CInstanceBase::EFFECT_DRAGON_ORANGE);

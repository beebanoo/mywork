...
void initchr()
{
	...
	PyObject * poModule = Py_InitModule("__t_2_c_h_r__", s_methods);
	...
	PyModule_AddIntConstant(poModule, "AFFECT_STR",							CInstanceBase::AFFECT_ST);
	PyModule_AddIntConstant(poModule, "AFFECT_DEX",							CInstanceBase::AFFECT_DX);
	...
	PyModule_AddIntConstant(poModule, "AFFECT_BINDING",						CInstanceBase::AFFECT_BINDING);

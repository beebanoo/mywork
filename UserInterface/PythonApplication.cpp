...
bool LoadLocaleData(const char* localePath)
{
	...
	snprintf(szItemProto,	sizeof(szItemProto),	"%s/item_proto_%s",	localePath, LocaleService_GetLocaleName());
	snprintf(szItemDesc,	sizeof(szItemDesc),	"%s/itemdesc.txt",	localePath);	
	snprintf(szMobProto,	sizeof(szMobProto),	"%s/mob_proto_%s",		localePath, LocaleService_GetLocaleName());	

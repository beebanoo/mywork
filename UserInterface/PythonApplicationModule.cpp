...
void initapp()
{
	...
	PyObject * poModule = Py_InitModule("__t_2_a_p_p__", s_methods);
	...
	PyModule_AddIntConstant(poModule, "LOCALE_DK", CPythonApplication::LOCALE_DK);
	...
	PyModule_AddIntConstant(poModule, "LOCALE_GR", CPythonApplication::LOCALE_GR);
	...
	PyModule_AddIntConstant(poModule, "LOCALE_NL", CPythonApplication::LOCALE_NL);
	...
	PyModule_AddIntConstant(poModule, "LOCALE_RU", CPythonApplication::LOCALE_RU);
	...
	PyModule_AddIntConstant(poModule, "ANI_SCALE_FUNCTION", 1);
#else
	PyModule_AddIntConstant(poModule, "ANI_SCALE_FUNCTION", 0);
#endif
...
#ifdef __BL_MOUSE_WHEEL_TOP_WINDOW__
	...
	PyModule_AddIntConstant(poModule, "ENABLE_TITLE_PERSO", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TITLE_PERSO", 0);
#endif

#ifdef ENABLE_DAMAGE_TOP
	PyModule_AddIntConstant(poModule, "ENABLE_DAMAGE_TOP",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DAMAGE_TOP",	0);
#endif
}
